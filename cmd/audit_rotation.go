...
// strictAuditRotatedFiles keeps preview ordering and selector validation aligned
// with the core's strict rotated-file contract.
	...
	for _, entry := range entries {
		...
		if !ok {
			return nil, apperrors.New(
				...
				fmt.Sprintf("unexpected audit rotation filename %q; refusing evidence mutation", name),
				nil,
			)
		}
